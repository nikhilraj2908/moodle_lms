...
$templatecontext['blockdraweropen'] = (get_user_preferences('drawer-open-block') == true);
...
if (isloggedin()) {
    echo $OUTPUT->render_from_template('theme_moove/sidebar_layout', $templatecontext);
